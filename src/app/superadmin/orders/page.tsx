...
export default function OrdersPage() {
  ...
  async function loadOrders() {
    ...
    setLoading(true);
    try { const res = await fetch('/api/orders?storeId=' + selectedStore); const data = await res.json(); setOrders(Array.isArray(data) ? data : []); } catch(e){} finally { setLoading(false); }
  }
