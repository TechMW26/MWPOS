// ============================================================
// Indian States & Districts Lookup
// Used for state→district cascading dropdowns
// ============================================================
...
export const INDIAN_STATES_DISTRICTS: Record<string, string[]> = {
  ...
  "Arunachal Pradesh": [
    ...
    "Kurung Kumey", "Lohit", "Lower Dibang Valley", "Lower Subansiri",
...
export const INDIAN_CITY_AREAS: Record<string, Record<string, string[]>> = {
  "Madhya Pradesh": {
    "Bhopal": [
      "Mahatma Gandhi Ward",
      "Airport Ward",
      ...
      "Koh-e-Fiza Ward",
      "Royal Market Ward",
      "Baag Munshi Hussain Ward",
      "Eidgah Hills Ward",
      "Babu Jagjivan Ram Ward",
      "Nariyal Kheda Ward",
      "Geetanjali Ward",
      "Shahjahanabad Ward",
      "J.P. Nagar Ward",
      ...
      "Dr. Ambedkar Ward",
      "Goswami Tulsidas Ward",
      "Rani Awantibai Ward",
      "Maulana Abdul Kalam Azad Ward",
      "Kushabhau Thakre Ward",
      "Chhatrapati Shivaji Ward",
      "Jawahar Lal Nehru Ward",
      "Pt. Madanmohan Malviya Ward",
      "Ravindra Nath Tagore Ward",
      "Jahangirabad Ward",
      "Chandbad Ward",
      "Kapdamil Ward",
      "Semra Ward",
      ...
      "Gautam Buddha Ward",
      "Sonagiri Ward",
      "Govindpura Audyogik Kshetra Ward",
      "Narela Shankari Ward",
      "Indrapuri Ward",
      "Ayodhya Nagar Ward",
      "Guru Nanak Dev Ward",
      "Punjabi Bagh Ward",
      "Dusshera Maidan Ashoka Garden Ward",
      "Rajiv Gandhi Ward",
      "Bhopal Memorial Hospital Ward",
      "Bhanpur Ward",
      "Badbai Ward",
      "Chhola Ward",
      "Rusalli Ward",
...
export function getAreasForCity(state: string, city: string): string[] {
  return INDIAN_CITY_AREAS[state]?.[city] || [];
}
